  ...
  <div class="case-num">
    <div class="container">
      <div class="title">
        <span
          >截至{{
            "  " + formateDate(CaseNum.modifyTime) + "  "
          }}全国数据统计</span
        >
      </div>
    </div>
            ...
            <div class="create-count">
              <b>
                较昨日<em style="color: rgb(247, 76, 49)">{{
                  CaseCompareSizes(CaseNum.currentConfirmedIncr)
                }}</em>
              </b>
            </div>
            ...
            <div class="create-count">
              <b>
                较昨日<em style="color: rgb(247, 130, 7)">
                  {{ CaseCompareSizes(CaseNum.confirmedIncr) }}</em
                >
              </b>
            </div>
            ...
            <div class="create-count">
              <b>
                较昨日<em style="color: rgb(174, 33, 44)">{{
                  CaseCompareSizes(CaseNum.suspectedIncr)
                }}</em>
              </b>
            </div>
        ...
        <li>
          <div class="create-item">
            <div class="create-count">
              <b>
                较昨日<em style="color: rgb(174, 33, 44)">
                  {{ CaseCompareSizes(CaseNum.curedIncr) }}</em
                >
              </b>
            </div>
            <strong style="color: rgb(174, 33, 44)">{{
            ...
            <div class="create-count">
              <b>
                较昨日<em style="color: rgb(93, 112, 146)">
                  {{ CaseCompareSizes(CaseNum.deadIncr) }}</em
                >
              </b>
            </div>
            ...
            <div class="create-count">
              <b>
                较昨日<em style="color: rgb(40, 183, 163)">
                  {{ CaseCompareSizes(CaseNum.seriousIncr) }}</em
                >
              </b>
            </div>
...
export default {
  ...
  methods: {
    formateDate(date) {
      ...
      var mm = date.getHours() < 10 ? "0" + date.getHours() : date.getHours();
      return YY + MM + DD + hh + mm;
    },
    CaseCompareSizes(num) {
